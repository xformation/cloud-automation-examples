    ...
    def add_resources(self):
        ...
        self.WebServerLaunchConfiguration = self.template.add_resource(autoscaling.LaunchConfiguration(
            ...
            UserData=Base64(Join("", [
                ...
                "--title='Vmworld Meet - ", Ref(
                    self.Environment), "' ",
                "--admin_user='root' ",
                "--admin_password='wordpress' ",
                "--admin_email='support@synectiks.com'\n",
                "wget  https://s3.amazonaws.com/synectiks-config/header.jpg -O /var/www/html/wp-content/themes/twentyseventeen/assets/images/header.jpg\n",
